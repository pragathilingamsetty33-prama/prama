...
export const deriveKeyFromPassword = async (password: string, userId: string): Promise<Uint8Array> => {
    ...
    // Cross-Platform Uniformity Fix: Use pure ASCII string
    // to guarantee identical JNI marshaling across Android, iOS, and Web.
    const saltStringForNative = userId.toLowerCase();
